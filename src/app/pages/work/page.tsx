...
const projects = [
    ...
    },
    {
        id: 16,
        title: 'Math IT',
        image: '/mathit-homepage.png',
        alt: 'Math IT — Learn Math the Fun Way',
        webSite: 'https://mathit-two.vercel.app/',
        githubUrl: '',
        category: 'Education',
        gradient: 'from-teal-500 via-cyan-500 to-blue-600',
        prevDescription: '<div><h1>Math IT: Learn Math the Fun Way</h1><p>Math practice for kindergarten through 5th grade, aligned with Indiana state Math Standards. Pick a grade, play games, and build skills — no login required. Progress is saved on the device so learners can pick up anytime.</p><h2>Why Math IT?</h2><ul><li><strong>Standards-aligned:</strong> Games and practice match Indiana math standards for K–5 so learning stays on track.</li><li><strong>No account needed:</strong> Pick a grade and play. Progress is saved on this device.</li><li><strong>Safe &amp; simple:</strong> Built for parents and caregivers. Check the Progress page anytime to see how your child is doing.</li></ul><h2>What you\'ll learn</h2><p>From counting and shapes to place value and operations — pick a grade and explore games built for kindergarten through 5th grade. Games cover addition, subtraction, place value, time, and money.</p><h2>Technology Stack:</h2><ul><li><strong>Frontend:</strong> Next.js, React, TypeScript, Tailwind CSS</li><li><strong>Backend:</strong> Next.js API Routes</li><li><strong>Deployment:</strong> Vercel</li></ul><p><strong>Purpose:</strong> Free math practice for K–5 at home, aligned with Indiana State Math Standards. Safe, simple, and free.</p></div>',
        frontend: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS'],
        backend: ['Next.js API Routes'],
        database: [],
    },
